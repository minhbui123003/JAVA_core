...
public class Employee extends javax.swing.JFrame implements ActionListener {
    ...
    public void Addcbb(){
        try {
            ...
            // tạo mảng lưu tên các phòng ban 
            int i=0;
            // lấy tên của từng phòng thêm vào mảng
...
// xóa các trường dữ liệu trong giao diện 
...
// điều chỉnh fontsize và màu chữ 
